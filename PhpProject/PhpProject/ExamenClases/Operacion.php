...
abstract class Operacion{
    ...
    protected $operando1 = 6;
    protected $operando2 = 9;
    protected $operacion = ["+","-","*",":"];
    protected $operador; 
    protected $tipo=""; 
    ...
    private function conseguirDatos($operacion){
            ...
            $arrayvalor = preg_split('/([\:|\+|\-|\*])/', $this->$operacion, -1, PREG_SPLIT_DELIM_CAPTURE);
     ...
     */
    private function comprobarRealRacional($operando1, $operando2){

        if (strpos($this->operando1,'/') || strpos($this->operando2,'/')){
            $this->type = "racional";
        } else {
            $this->type = "real";
        }
    ...
    public function imprimir($resultado){
        echo "<table><tr>";
        echo "<td>Resultado</td></tr><tr><td>Operador1</td></tr><tr><td>Operando2</td></tr>";
        echo "<tr><td>".$this->resultado."</td></tr><tr><td>".$this->operando1."</td></tr><tr><td>".$this->operando2."</td></tr><t</table>";
        return $this->resultado;
    }

    // TODO: Implementa los getters y setters que necesites
    public function setOperando1(){
        return $this->operando1;
    }
    
    public function getOperando1($operando1){
        $this->operando1;
    }
    
    public function setOperando2(){
        return $this->operando2;
    }
    
    public function getOperando2($operando2){
        $this->operando2;
    }
    ...
    public function __toString() {
        return "Calculo: ". $this->operando1. $this->operacion. $this->operando2. " = " .$this->resultado;
    }
}
?>