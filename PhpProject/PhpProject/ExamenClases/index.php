...
//
require '../ExamenClases/Operacion.php';
require '../ExamenClases/OperacionRacional.php';
require '../ExamenClases/OperacionReal.php';
require '../ExamenClases/Racional.php';
